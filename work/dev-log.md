...
| B1(部分) | 2026-08-23 | PKG-13(全)、PKG-08 L-5/L-6(auth+SSE+schema) | 会话台账待回填 | — | 约 900(服务端+文档) | 修复后通过:lint/test(52)/build 全绿;迁移执行待 Docker 修复 | 待签 | L-2 业务表补全与 PKG-09 客户端壳未做;同日 client 过 Unity 验证(编译 0 error+15/15) |
